...
function getImageURLs($keyword, $orientation="horizontal") {
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => "https://pixabay.com/api/?key=10280471-337350be475ad79b40d8bc1fe&q=$keyword&category=$category&image_type=photo&orientation=$orientation&safesearch=true&per_page=100",
